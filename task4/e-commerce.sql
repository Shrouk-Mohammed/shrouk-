...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 23, 2022 at 07:57 PM
...
CREATE TABLE `admins` (
  ...
  `verification_cod` int(6) DEFAULT NULL,
...
CREATE TABLE `cities` (
  ...
  `region_id` bigint(20) UNSIGNED DEFAULT NULL COMMENT '1 =>active\r\n0=>not active',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `copouns` (
  ...
  `max_discount_value` decimal(4,3) DEFAULT NULL,
  `mini_order_price` int(1) NOT NULL,
  `number_of_usage_per_user` int(1) NOT NULL,
  `max_number_of_usage` int(1) NOT NULL,
...
CREATE TABLE `orders` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `total_price` decimal(7,2) NOT NULL COMMENT '1=>active\r\n0=>not active',
...
CREATE TABLE `users` (
  ...
  `status` tinyint(1) DEFAULT 1 COMMENT '1=>active,0=>block,2=>banned',
...
--
ALTER TABLE `addresses`
  ADD CONSTRAINT `addresses_ibfk_1` FOREIGN KEY (`region_id`) REFERENCES `region` (`id`),
...
--
ALTER TABLE `orders`
  ADD CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`coupons_id`) REFERENCES `copouns` (`id`),
...
ALTER TABLE `products`
  ...
  ADD CONSTRAINT `products_ibfk_2` FOREIGN KEY (`subcategory_id`) REFERENCES `sub_categories` (`id`);
