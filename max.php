...
if($_POST)
{
    ...
    if($num1>$num2 && $num1>$num3)
        {
            $max = "the max num is ".$num1;  
        }
    elseif($num2>$num1 && $num2>$num3)
    {
         $max = "the max num is ".$num2;
    }
    else
    {
        $max = "the max num is ".$num3;
    }
    if($num1<$num2 && $num1<$num3)
    {
        $min = "the min num is ".$num1;  
    }
elseif($num2<$num1 && $num2<$num3)
{
     $min = "the min num is ".$num2;
}
else
{
    $min = "the min num is ".$num3;
}
